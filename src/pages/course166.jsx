      ...
      <>
        ...
        <div className="c166framewindow-container">
          <div className={`c166sssidebar ${showSsSidebar ? 'show' : ''}`}>
            <div className='c166framecourse'>
            <Link
          to="/course-166"
          className={`c166coursebutton ${showSsSidebar ? 'purple-button' : ''}`}
        ...
        >
            ...
            <div className='c166logoutbutton'>  <svg  xmlns="http://www.w3.org/2000/svg" width="26" height="22" viewBox="0 0 29 25" fill="none">
          ...
          <div
          className={`c166coursetopictext ${showSsSidebar ? 'move-right' : ''}`}
          onClick={handleSidebarClick}> Course 1/66</div>
          <div
          className={`c166datetext ${showSsSidebar ? 'move-right' : ''}`}
