      ...
      <>
        ...
        <div className="framewindow-container">
          <div className={`sssidebar ${showSsSidebar ? 'show' : ''}`}>
            <div className='framecourse'>
            <Link
          to="/course-166"
          className={`coursebutton ${showSsSidebar ? 'purple-button' : ''}`}
        ...
        >
            ...
            <div className='logoutbutton'>  <svg  xmlns="http://www.w3.org/2000/svg" width="26" height="22" viewBox="0 0 29 25" fill="none">
            ...
            <div className='profilebutton'> <svg xmlns="http://www.w3.org/2000/svg" width="22" height="24" viewBox="0 0 26 28" fill="none">
          ...
          <div
          className={`coursetopictext ${showSsSidebar ? 'move-right' : ''}`}
          onClick={handleSidebarClick}> Course 1/66</div>
          <div
          className={`datetext ${showSsSidebar ? 'move-right' : ''}`}
          onClick={handleSidebarClick}> 5 Aug, 2023</div>
          <div className={`courseframewindow ${showSsSidebar ? 'shrink' : ''}`}>
