...
const Component = ({ showSsSidebar, setShowSsSidebar }) => {
  ...
  return (
    <div className='insDaNavBar'>
      ...
      <img src={cmulogo} alt="CMULogo" className="insDacmulogo" />
      <p className="insDahellostyle">Hello, Dome P.</p>
      <p className="insDarolestyle">1/66, Instructor</p>
    </div>
  );
};
      ...
      <div className="insDaframewindow-container">
        ...
        <div className={`insDasssidebar ${showSsSidebar ? 'show' : ''}`}>
          ...
          `<Link to="/course-166" className="insDacoursebutton">
            ...
            <div className='insDacoursebutton'> 
              <svg xmlns="http://www.w3.org/2000/svg" width="11" height="16" viewBox="0 0 11 16" fill="none">
              <path d="M9.74365 8.83008L3.10303 15.4707C2.64404 15.9297 1.90186 15.9297 1.44775 15.4707L0.344238 14.3672C-0.114746 13.9082 -0.114746 13.166 0.344238 12.7119L5.05127 8.00488L0.344238 3.29785C-0.114746 2.83887 -0.114746 2.09668 0.344238 1.64258L1.44287 0.529297C1.90186 0.0703125 2.64404 0.0703125 3.09814 0.529297L9.73877 7.16992C10.2026 7.62891 10.2026 8.37109 9.74365 8.83008Z" fill="black"/>
              </svg> Course 3/65
            </div>
          ...
          <button onClick={signOut} className='insDalogoutbutton'  >  <svg  xmlns="http://www.w3.org/2000/svg" width="26" height="22" viewBox="0 0 29 25" fill="none">
          ...
          <div className='insDaprofilebutton'> <svg xmlns="http://www.w3.org/2000/svg" width="22" height="24" viewBox="0 0 26 28" fill="none">
