...
export default function UploadScorePageContainer() {
  ...
  return (
    <>
      <div className={"positionUpload"}>
        <div
          className={`uploadScorecourseframewindow1 ${
            showSidebar ? "shrink" : ""
          }`}
        >
          ...
          <div className="uploadScoreInlineContainer">
            <div
              className="uploadScoreCancelButton"
            ...
            <div
              className="uploadScoreConfirmButton"
          ...
          <div className="uploadScorePopup">
            <div className="uploadScorePopup-Content">
              ...
              <div className="UploadScorePopupButtons">
                <button
                  className="UploadScoreCancelPopupStayButton"
                  onClick={CancelCancelhandleClosePopup}
                >
                  Stay
                </button>
                <button
                  className="UploadScoreCancelPopupLeaveButton"
          ...
          <div className="uploadScorePopup">
            <div className="uploadScorePopup-Content">
              ...
              <div className="UploadScorePopupButtons">
                ...
                <button
                  className="UploadScoreCancelPopupLeaveButton"
                  onClick={ConfirmConfirmhandleClosePopup}
                >
                  Yes, Upload
                </button>
              </div>
