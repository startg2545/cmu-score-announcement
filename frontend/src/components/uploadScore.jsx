  ...
  return (
    <>
      <div className="flex flex-col justify-start py-10 lg:px-24 px-2 overflow-y-scroll max-h-max">
        ...
        <p className="bg-[#FCEFCD] rounded-lg p-3 my-3">
        ...
        <div className="flex flex-row w-full p-3 gap-3 ">
          ...
          >
            <p className="text-red-500 px-3 text-center items-center flex font-semibold group-hover:bg-red-500 group-hover:text-white duration-150 transition-all bg-white h-full">
              CANCEL
            </p>
          ...
          >
            <p
              className={`px-3 text-center items-center flex font-semibold duration-150 transition-all bg-white h-full
                ${
                  isFileUploaded
      ...
      >
        <div className="overflow-hidden">
          <div className="bg-primary flex justify-center py-3 shadow-xl">
            <p className="text-white lg:text-2xl text-xl font-semibold text-center">
              Leave this page?
            </p>
          </div>
          <h1 className="text-9xl text-primary font-black text-center">?</h1>
      ...
      >
        <div className="overflow-hidden">
          <div className="bg-primary flex justify-center p-5 shadow-xl">
          ...
          <p className="text-center my-3 mx-12 text-gray-700">
