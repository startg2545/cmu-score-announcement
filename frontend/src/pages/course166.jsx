          ...
          <>
            <div className={Course.MenuNavigate}>
              <p className={Course.MenuIndex}>
                ...
                <label onClick={backToDashboard} style={{cursor: 'pointer'}} className={` ${Course.date} ${
              showSidebar ? Course.moveRight : ""
            }`}>
                ...
                <label onClick={backToCourse} id="tab-menu" className={` ${Course.date} ${
              showSidebar ? Course.moveRight : ""
            }`}>
                  {params.courseNo} 
                </label>
              </p>
              <div className={`${Course.frameCourseDash} ${
              showSidebar ? Course.shrink : ""
            }`}>
                <div className={`${Course.navbarCourseDash} ${
                showSidebar ? Course.shrink : ""
              }`}> 
