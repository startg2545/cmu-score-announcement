              ...
              <>
                <div
                  className=" text-maintext font-semibold cursor-default py-2 
                                 xl:mt-14 lg:mt-19 md:mt-16 sm:mt-16 mt-16 
                ...
                <div className="mx-[1%] lg:mt-3 max-h-fit bg-slate-50">
                  <div className=" lg:rounded-xl rounded-xl xl:h-[calc(90vh-50px)] lg:h-[calc(89vh-30px)] md:h-[calc(93vh-50px)] h-[calc(93vh-90px)] overflow-hidden border-[3px] border-primary">
