      ...
      <div className="flex flex-row gap-3 justify-center overscroll-y-none">
        ...
        <div className="flex w-full flex-col h-full overflow-x-auto">
          <div className="mx-[2%] lg:mt-3 max-h-screen ">
            <div className="lg:rounded-xl rounded-xl xl:h-[calc(89vh-60px)] lg:h-[calc(88vh-60px)] md:h-[calc(89vh-55px)]  h-[calc(88vh-90px)] overflow-hidden border-[3px] border-primary mt-24">
              <div className="flex flex-col">
