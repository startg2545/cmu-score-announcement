...
import { Button, Center, Flex, Text, List } from "@mantine/core";
...
const ErrorView = () => {
  ...
  return (
    <div className="popupLogin">
      <Center>
        <Flex align="center" direction="column" gap={18}>
          <svg
          ...
          <List size="sm">
            <List.Item>
              Make sure you open this website on a PC or laptop.
            </List.Item>
          </List>
          <Button
            maw={125}
            ...
            mt={15}
            sx={{
              backgroundColor: "#8584c5",
              "&:hover": {
                backgroundColor: "#696cA3",
              },
            }}
