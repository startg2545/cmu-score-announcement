    ...
    <>
      <UploadScorePage showSsSidebar={showSsSidebar} setShowSsSidebar={setShowSsSidebar} />
        <div className={`uploadScoresssidebar ${showSsSidebar ? 'show' : ''}`}>
          <div className='uploadScoreframeCourseInSideBar'>
            <Link to="/course-166" className={`uploadScorecoursebutton ${showSsSidebar ? 'uploadScorepurple-button' : ''}`} onClick={handleSidebarClick}>
        ...
        <div className={`uploadScorecourseframewindow ${showSsSidebar ? 'shrink' : ''}`}>
          ...
          <div className="uploadScoreInlineContainer">
            <div className='uploadScoreCancelButton'onClick={handleCancelClick}>
            ...
            <div className='uploadScoreConfirmButton' onClick={handleConfirmClick} >
        ...
        {showPopupCancel && (
        <div className="uploadScorePopup">
          <div className="uploadScorePopup-Content">
            <div className='uploadScorePopup-ContentInner'>
              <p style={{color: 'white', fontWeight: '600'}}>Leave this page?</p>
            </div>
          <svg xmlns="http://www.w3.org/2000/svg" width="75" height="76" viewBox="0 0 55 96" fill="none">
          ...
          <p>This data will be discarded</p>
            <div className="UploadScorePopupButtons">
              <button className="UploadScoreCancelPopupStayButton" onClick={CancelCancelhandleClosePopup}>
                Stay
              </button>
              <button className="UploadScoreCancelPopupLeaveButton" onClick={CancelConfirmhandleClosePopup}>
                Yes, leave
              </button>
            </div>
          </div>
      ...
      {showPopupConfirm && (
        <div className="uploadScorePopup">
          <div className="uploadScorePopup-Content">
            <div className='uploadScorePopup-ContentInner'>
              <p style={{color: 'white', fontWeight: '600'}}>Upload this data?</p>
            </div>
          <div className='UploadScoreSvgInline'>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="45" viewBox="0 0 44 40" fill="none" transform="translate(-4, 15)" >
